...
## Try it
The latest version of this example is `1.0.2`. So, you can download the [`1.0.1`](https://github.com/MBigje/electron-updater-app/releases/tag/v1.0.1) one and see how the app finds the new version and downloads it.


## To begin

```bash
$ git clone https://github.com/MBigje/electron-updater-app.git
...
- [Configure package.json](#configure-packagejson)
  - build > publish
- [Release](#release):
  - Create a [realease](https://github.com/MBigje/electron-updater-app/releases)
...
```yml
appId: com.MBigje.electron-updater-app
publish:
  provider: github
  owner: MBigje
...
<table>
  <tr>
    <td>
      <img src="https://github.com/MBigje.png?s=100" width="100"/>
    </td>
    <td>
      Natan Cabral<br />
      <a href="mailto:MBigje@hotmail.com">MBigje@hotmail.com</a><br />
      <a href="https://github.com/MBigje/">https://github.com/MBigje/</a>
    </td>
  </tr>
</table>
